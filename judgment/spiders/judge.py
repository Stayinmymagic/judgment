...
class JudgeSpider(scrapy.Spider):
    ...
    def __init__(self, id = '', name = '', age = 0, currentAddress = '', 
                 companyAddress = '', residenceAddress = '', fatherName = '',motherName = ''):
        self.id = id 
        self.name = name
        self.age = age
        ...
        # self.lender_info = data
        self.proxy = 'https://45.129.183.14:3128'
        ...
        dict_key = ['id','name','currentAddress','fatherName', 'motherName','companyAddress','residenceAddress','age']
        self.lender_info = dict(zip(dict_key, [self.id,self.name,self.currentAddress,self.fatherName, 
                                               self.motherName,self.companyAddress,self.residenceAddress,self.age]))
    ...
    def parse_court(self, response):
        print(response.css('iframe::attr(src)').extract())
    ...
    def parse_case(self, response):
        ...
        if len(response_list) == 0:
            ...
            # 關鍵字
            keywords = ['本票裁定','支付命令' ,'協商認可','詐欺','洗錢防制法','給付簽帳卡', '槍砲彈藥','清償借款'\
